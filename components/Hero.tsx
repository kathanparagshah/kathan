    ...
    <section className="relative min-h-screen bg-gradient-to-br from-dark-bg via-dark-surface to-dark-bg overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-6xl mx-auto w-full">
          ...
          >
            Bachelors of Science in Computer Science | Growth marketing Intern at Nextiva
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open(process.env.GITHUB_PAGES === 'true' ? '/kathan/Master Resume.pdf' : '/Master Resume.pdf', '_blank')}
