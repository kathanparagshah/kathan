...
const About = () => {
  ...
  const quickFacts = [
    ...
    { label: 'Major', value: 'Bachelors of Science in Computer Science with a Minor in Economics' },
          ...
          <div className="space-y-8">
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                I'm a passionate student with a Major in Computer Science and Minor in Economics at Arizona State University, 
