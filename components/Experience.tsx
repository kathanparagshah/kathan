  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      description: [
        'Analyzed customer acquisition channels using data-driven insights to identify high-converting strategies, optimizing ad spend efficiency by 15%',
        'Collaborated with the marketing team to execute targeted campaigns, leveraging analytics to refine messaging and improve user engagement metrics across key platforms'
      ],
      technologies: ['Growth Hacking', 'Data Analytics', 'SEO/SEM', 'Marketing Automation', 'A/B Testing'],
      achievements: [
        'Optimized ad spend efficiency by 15%',
        'Improved user engagement metrics',
        'Executed data-driven marketing campaigns'
      ],
      type: 'work',
      color: '#f43f5e'
    },
    ...
    {
      id: 9,
      title: 'Bachelor of Science in Computer Science and Minor in Economics',
              ...
              <div className="relative w-full h-full flex items-center justify-center perspective-1000">
                {experiences.map((exp, index) => {
                  ...
                  return (
                    <motion.div
                      key={exp.id}
                      className="absolute w-96 md:w-[28rem] h-96 md:h-[28rem] p-6 cursor-pointer"
                      style={{
